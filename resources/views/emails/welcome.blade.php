...
<head>
    ...
    <title>{{ __('app.emails.welcome.subject', ['app' => config('app.name')]) }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
                    <tr>
                        <td style="padding:28px 32px 12px;">
                            ...
                            <h1 style="margin:0;font-size:24px;font-weight:700;color:#111827;">
                                {{ __('app.emails.welcome.heading', ['name' => $user->name]) }}
                            </h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:8px 32px 0;font-size:15px;color:#374151;">
                            <p style="margin:0 0 16px;">{{ __('app.emails.welcome.intro') }}</p>
                            <p style="margin:0 0 16px;">{{ __('app.emails.welcome.body') }}</p>
                        </td>
                    </tr>
                    @if ($verificationUrl)
                        <tr>
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="border-radius:10px;background:#0c7a61;">
                                            <a href="{{ $verificationUrl }}" style="display:inline-block;padding:14px 24px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                                                {{ __('app.emails.welcome.activate_button') }}
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td style="padding:16px 32px 0;font-size:13px;color:#6b7280;">
                                <p style="margin:0 0 8px;">{{ __('app.emails.welcome.expires', ['minutes' => config('auth.verification.expire', 5)]) }}</p>
                        ...
                        <tr>
                            <td style="padding:8px 32px 0;">
                                <table role="presentation" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="border-radius:10px;background:#0c7a61;">
                                            <a href="{{ url(route('login')) }}" style="display:inline-block;padding:14px 24px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
                                                {{ __('app.emails.welcome.login_button') }}
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <tr>
                        <td style="padding:24px 32px 28px;font-size:13px;color:#6b7280;">
                            <p style="margin:0;">{{ __('app.emails.welcome.footer') }}</p>
                        </td>
                    </tr>
                </table>
            </td>
