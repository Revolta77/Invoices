<div class="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
    <h2 class="text-xl font-semibold">Registrácia</h2>
    <p class="mt-1 text-sm text-slate-600">Vytvorte si nový účet</p>

    <form wire:submit="register" class="mt-6 space-y-5">
        <div>
            <label for="name" class="block text-sm font-medium text-slate-700">Meno</label>
            <input
                wire:model="name"
                id="name"
                type="text"
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-medium text-slate-700">Potvrdenie hesla</label>
            <input
        ...
        >
            <span wire:loading.remove wire:target="register">Zaregistrovať sa</span>
            <span wire:loading wire:target="register">Registrujem...</span>
        </button>
    </form>
